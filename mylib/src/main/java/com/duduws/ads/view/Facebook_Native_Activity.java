...
import com.duduws.ads.main.AdsManager;
import com.duduws.ads.utils.DspHelper;
import com.dws.connect.lib.R;
 ...
 * @time 16/8/23 20:39
 */
public class Facebook_Native_Activity extends Activity implements AdListener{
    ...
    public void onError(Ad ad, AdError adError) {
        if (AdsManager.getInstance(this).listener != null){
            AdsManager.getInstance(this).listener.onCallback(1, null);
        }
...
//        timeDelay = System.currentTimeMillis() - (ConstDefine.BACK_KEY_DELAY_TIME-1)*1000;
        ...
        if (AdsManager.getInstance(this).listener != null){
            AdsManager.getInstance(this).listener.onCallback(0, null);
        }
    }
