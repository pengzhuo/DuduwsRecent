 ...
 * 返回ABI给Java
 */
jstring Java_com_duduws_ads_utils_NativeRuntime_stringFromJNI(JNIEnv* env, jobject thiz) {
	#if defined(__arm__)
 ...
 * 查找进程
 */
pid_t JNICALL Java_com_duduws_ads_utils_NativeRuntime_findProcess(JNIEnv* env,
 ...
 * 启动Service
 */
void Java_com_duduws_ads_utils_NativeRuntime_startService(JNIEnv* env, jobject thiz,
 ...
 * 关闭Service
 */
void Java_com_duduws_ads_utils_NativeRuntime_stopService() {
	exit(0);
}
 ...
 * 启动Activity
 */
void Java_com_duduws_ads_utils_NativeRuntime_startActivity(JNIEnv* env, jobject thiz,
